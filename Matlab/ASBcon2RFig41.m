...
legend('violations (v^{t})','Bin edge = 37','apprehension rate (a^{t}/v^{t})')
title('Panel 1: Illustrative path of violation and apprehensions')
hold off
nexttile
hold on
box on
...
text(2172,40,txt2);
%text(2180,30,txt2);
title('Panel 2: Illustrative path of deterrence resource (R) deployment')
hold off 
nexttile
hold on
box on
...
xlim([2100 2300])
legend('Objective probability of apprehension','Subjective probability of apprehension')
xlabel('Tics(t)')
