...
title('Panel: Persistence of the q-attractors')
legend('log_{10} of ED in GB','log_{10} of ED in BB')
legend boxoff
xlim([39 43])
...
title('Panel 2: Proportion of time spent in q-attractors') 
...
xlabel('Deterrencd resources (R)')
legend('mean - modal violations')
legend boxoff
hold off

% Figure 3.6: ASBconV2Fig36.m

% Figure 3.7: ASBconV2Fig37.m

% Figure 3.8:  ASBconFig38.m
