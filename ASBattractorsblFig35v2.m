% ASBattractorsblFig34V2.m
% Uses input from ASBEquilibMDL.m
% Revised Aug 26, 2022, K. I. Carlaw 
clear
...
PR=2;
R=[44]; % vectore of R values. Toggle
RR=1;
Z=2;
...
title('Expected violations given current violations, R = 44')
legend boxoff
txt={'v^{t}=17'};
text(15,-3,txt);
txt1={'v^{t}=54'};
...
hold on
box on
plot(vEq2,PrEq2(44,:),'Color','k');
area(vEq2,TPrEq2(44,:),'FaceColor',[0.6 0.6 0.6]);
area(vEq2,GPrEq2(44,:),'FaceColor',[0.9 0.9 0.9]);
area(vEq2,BPrEq2(44,:),'FaceColor',[0.1 0.1 0.1]);
title('Panel 1: Probability of an equilibrium with v violations, R = 44')
xlabel('Number of violations (v)')
txt={'{\leftarrow} Probability of good eq (v \leq 30)'};
text(18,0.10,txt);
txt1={'Probability of other eq (30 < v < 70){\downarrow}'};
text(50,0.025,txt1);
txt2={'Probability of bad eq (v \geq 70) {\downarrow}'} ;
text(75,0.075,txt2);
ylim([0 0.15])
hold off
